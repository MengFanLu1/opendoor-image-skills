...
- macOS/Linux: `<repo_dir>/.venv/bin/python3 <repo_dir>/scripts/generate.py`
- Windows: `<repo_dir>\.venv\Scripts\python.exe <repo_dir>\scripts\generate.py`
...
```bash
# Python - macOS / Linux
~/code/opendoor-image-skills/.venv/bin/python3 ~/code/opendoor-image-skills/scripts/generate.py "提示词"

# Python - Windows (PowerShell)
~\code\opendoor-image-skills\.venv\Scripts\python.exe ~\code\opendoor-image-skills\scripts\generate.py "提示词"
...
```bash
# Python
~/code/opendoor-image-skills/.venv/bin/python3 ~/code/opendoor-image-skills/scripts/generate.py "提示词" --model gpt-image-2
